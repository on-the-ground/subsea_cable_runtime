...
- Related SCP: [Draft: structure-valued lookup maps](https://github.com/on-the-ground/subsea_cable_language/blob/carousel-poc/proposals/draft-structure-valued-lookup-maps.md)
