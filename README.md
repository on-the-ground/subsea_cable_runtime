...
| Contract | Revision |
|---|---|
| Grammar, conformance corpus, `README.md` semantics, and accepted SCPs | `on-the-ground/subsea_cable_language@18941f9` (the `language` submodule; companion language PR #5) |
